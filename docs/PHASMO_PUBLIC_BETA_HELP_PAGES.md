...
- `/phasmo/privacy`
- `/phasmo/terms`
- `/phasmo/data-retention`

## Purpose

These pages are meant to give new streamers/testers clear expectations without making the app feel like a corporate SaaS product.

## Future improvements

- Link these pages from the Kaizen Controller main website.
